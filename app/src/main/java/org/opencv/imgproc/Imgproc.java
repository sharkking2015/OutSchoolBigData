...
public class Imgproc {
    ...
    /**
     *自适应二值化，原理是将图片切割成若干小块，对每小块分别进行二值化
     * @param src
     * @param dst
     * @param maxValue   255
     * @param adaptiveMethod ADAPTIVE_THRESH_MEAN_C 和 ADAPTIVE_THRESH_GAUSSIAN_C 。即采用均值活高斯
     * @param thresholdType THRESH_BINARY 和THRESH_BINARY_INV
     * @param blockSize  切割的图片大小
     * @param C 获取到均值活高斯获取的之后，需要减去这个C，得到的值即为阈值
     */
